...
export const GAME_TYPES = [
  ...
  },
  {
    id: 'snake',
    name: 'Snake',
    description: 'Classic snake game! Eat apples and grow longer without hitting walls.',
    icon: '🐍',
    color: '#16A34A',
    difficulty: 'Medium',
    avgDuration: '60s',
  ...
  },
  {
    id: 'slot-machine',
    name: 'Slot Machine',
    description: 'Pull the lever and try your luck! Match symbols to win big.',
    icon: '🎰',
    color: '#B91C1C',
    difficulty: 'Easy',
    avgDuration: '20s',
  },
  {
    id: 'brick-breaker',
    name: 'Brick Breaker',
    description: 'Classic breakout! Bounce the ball to smash all the bricks.',
    icon: '🧱',
    color: '#7C3AED',
    difficulty: 'Hard',
    avgDuration: '90s',
  },
  {
    id: 'fruit-catcher',
    name: 'Fruit Catcher',
    description: 'Catch falling fruits in your basket! Avoid the bombs.',
    icon: '🍎',
    color: '#059669',
    difficulty: 'Easy',
    avgDuration: '45s',
