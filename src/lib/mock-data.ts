...
export const mockCampaigns: Campaign[] = [
  ...
  },
  {
    ...
    config: {
      gameType: 'snake',
      tenant: { brandName: 'Gami Demo', logoUrl: '', primaryColor: '#16A34A', secondaryColor: '#FFFFFF' },
      campaign: { id: 'camp_006', title: 'Snake Challenge', duration: 60, winCondition: { type: 'score', threshold: 100 } },
      reward: { type: 'coupon', code: 'SNAKE15', displayText: '15% off your order' },
      collectEmail: true,
      leaderboardEnabled: true,
      maxPlaysPerUser: 5,
      difficulty: 'medium',
    ...
    updatedAt: '2026-04-20T10:00:00Z',
    stats: { totalSessions: 2100, uniquePlayers: 1400, avgScore: 85, conversionRate: 18.2, totalRewardsIssued: 255, avgDuration: 45 },
  },
  {
    id: 'camp_007',
    tenantId: 'ten_001',
    name: 'Whack-a-Mole Frenzy',
    description: 'Whack moles and win prizes!',
    gameType: 'whack-a-mole',
    status: 'active',
    config: {
      gameType: 'whack-a-mole',
      tenant: { brandName: 'Gami Demo', logoUrl: '', primaryColor: '#92400E', secondaryColor: '#FFFFFF' },
      campaign: { id: 'camp_007', title: 'Whack-a-Mole', duration: 30, winCondition: { type: 'score', threshold: 150 } },
      reward: { type: 'coupon', code: 'WHACK25', displayText: '25% off selected items' },
      collectEmail: true,
      leaderboardEnabled: false,
      maxPlaysPerUser: 3,
      difficulty: 'easy',
    ...
    endAt: '2026-06-22T23:59:59Z',
    createdAt: '2026-04-20T10:00:00Z',
    updatedAt: '2026-04-22T10:00:00Z',
    stats: { totalSessions: 4500, uniquePlayers: 3200, avgScore: 120, conversionRate: 28.5, totalRewardsIssued: 912, avgDuration: 28 },
  },
  {
    id: 'camp_008',
    tenantId: 'ten_001',
    name: 'Lucky Slots',
    description: 'Spin the slots and test your luck!',
    gameType: 'slot-machine',
    status: 'active',
    config: {
      gameType: 'slot-machine',
      tenant: { brandName: 'Gami Demo', logoUrl: '', primaryColor: '#B91C1C', secondaryColor: '#FFD700' },
      campaign: { id: 'camp_008', title: 'Lucky Slots', duration: 30, winCondition: { type: 'score', threshold: 50 } },
      reward: { type: 'coupon', code: 'LUCKY30', displayText: '30% off your purchase' },
      collectEmail: true,
      leaderboardEnabled: false,
      maxPlaysPerUser: 1,
      difficulty: 'easy',
    },
    startAt: '2026-04-23T00:00:00Z',
    endAt: '2026-06-23T23:59:59Z',
    createdAt: '2026-04-21T10:00:00Z',
    updatedAt: '2026-04-23T10:00:00Z',
    stats: { totalSessions: 8200, uniquePlayers: 6100, avgScore: 45, conversionRate: 38.0, totalRewardsIssued: 2318, avgDuration: 18 },
  },
  {
    id: 'camp_009',
    tenantId: 'ten_001',
    name: 'Brick Breaker Blast',
    description: 'Smash all the bricks to win!',
    gameType: 'brick-breaker',
    status: 'active',
    config: {
      gameType: 'brick-breaker',
      tenant: { brandName: 'Gami Demo', logoUrl: '', primaryColor: '#7C3AED', secondaryColor: '#FFFFFF' },
      campaign: { id: 'camp_009', title: 'Brick Breaker', duration: 90, winCondition: { type: 'score', threshold: 200 } },
      reward: { type: 'coupon', code: 'BREAK20', displayText: '20% off electronics' },
      collectEmail: true,
      leaderboardEnabled: true,
      maxPlaysPerUser: 3,
      difficulty: 'hard',
    },
    startAt: '2026-04-24T00:00:00Z',
    endAt: '2026-06-24T23:59:59Z',
    createdAt: '2026-04-22T10:00:00Z',
    updatedAt: '2026-04-24T10:00:00Z',
    stats: { totalSessions: 1800, uniquePlayers: 1200, avgScore: 165, conversionRate: 15.5, totalRewardsIssued: 186, avgDuration: 72 },
  },
  {
    id: 'camp_010',
    tenantId: 'ten_001',
    name: 'Fruit Basket Bonanza',
    description: 'Catch falling fruits and win rewards!',
    gameType: 'fruit-catcher',
    status: 'active',
    config: {
      gameType: 'fruit-catcher',
      tenant: { brandName: 'Gami Demo', logoUrl: '', primaryColor: '#059669', secondaryColor: '#FFFFFF' },
      campaign: { id: 'camp_010', title: 'Fruit Catcher', duration: 45, winCondition: { type: 'score', threshold: 200 } },
      reward: { type: 'freebie', code: 'FRUIT50', displayText: '50% off fresh produce' },
      collectEmail: false,
      leaderboardEnabled: false,
      maxPlaysPerUser: 5,
      difficulty: 'easy',
    ...
    endAt: '2026-06-25T23:59:59Z',
    createdAt: '2026-04-23T10:00:00Z',
    updatedAt: '2026-04-25T10:00:00Z',
    stats: { totalSessions: 3100, uniquePlayers: 2400, avgScore: 180, conversionRate: 22.0, totalRewardsIssued: 528, avgDuration: 40 },
  },
  {
    id: 'camp_011',
    tenantId: 'ten_001',
    name: 'Memory Master',
    description: 'Test your memory and find all matching pairs!',
    gameType: 'draw-line',
    status: 'active',
    config: {
      gameType: 'draw-line',
      tenant: { brandName: 'Gami Demo', logoUrl: '', primaryColor: '#0EA5E9', secondaryColor: '#FFFFFF' },
      campaign: { id: 'camp_011', title: 'Memory Master', duration: 60, winCondition: { type: 'score', threshold: 200 } },
      reward: { type: 'coupon', code: 'MEMORY10', displayText: '10% off everything' },
      collectEmail: true,
      leaderboardEnabled: true,
      maxPlaysPerUser: 3,
      difficulty: 'easy',
    ...
    createdAt: '2026-04-23T10:00:00Z',
    updatedAt: '2026-04-25T10:00:00Z',
    stats: { totalSessions: 2700, uniquePlayers: 2000, avgScore: 250, conversionRate: 32.0, totalRewardsIssued: 640, avgDuration: 50 },
  },
]
