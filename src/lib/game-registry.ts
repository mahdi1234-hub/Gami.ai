...
export const ALL_CAMPAIGNS: GameCampaign[] = [
  ...
  { id: 'g62', name: 'Shadow Fight Arena', description: 'Battle in the shadows! Best of 3 rounds fighting game.', gameType: 'shadow-fight', primaryColor: '#7C3AED', brandName: 'FightClub', duration: 90, winThreshold: 1, rewardCode: 'FIGHT50', rewardText: '50% off martial arts gear', collectEmail: true, difficulty: 'hard' },
  { id: 'g63', name: 'Ninja Shadow Battle', description: 'Ninja vs Ninja shadow combat!', gameType: 'shadow-fight', primaryColor: '#DC2626', brandName: 'NinjaShop', duration: 90, winThreshold: 1, rewardCode: 'NINJA25', rewardText: '25% off ninja gear', collectEmail: false, difficulty: 'hard' },
  { id: 'g64', name: 'Dark Arena Duel', description: 'Enter the dark arena and fight!', gameType: 'shadow-fight', primaryColor: '#1E293B', brandName: 'DarkArena', duration: 60, winThreshold: 1, rewardCode: 'DARK30', rewardText: '30% off dark collection', collectEmail: true, difficulty: 'hard' },
]
